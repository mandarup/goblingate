...
LOWER_TANK_LOW = 50  # 800
LOWER_TANK_HIGH = 5  # 20

UPPER_RELAY_MAX_DUR = 100
...
def test_init():
    upper_tank = Tank(low=UPPER_TANK_LOW, high=UPPER_TANK_HIGH)
    lower_tank = Tank(low=LOWER_TANK_LOW, high=LOWER_TANK_HIGH)
